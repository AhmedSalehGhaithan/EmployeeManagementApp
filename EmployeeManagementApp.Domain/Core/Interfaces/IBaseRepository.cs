...
namespace EmployeeManagementApp.Domain.Core.Interfaces;
...
public interface IBaseRepository<TEntity> where TEntity : class
{
    ...
    virtual Task<TEntity?> GetByIdAsync(Guid Id, Func<IQueryable<TEntity>, IQueryable<TEntity>>? include = null, CancellationToken cancellationToken = default)
        => throw new NotImplementedException();
