...
namespace EmployeeManagementApp.Infrastructre.Repositories;
public class BaseRepository<TDbContext, TEntity>(TDbContext context)
    ...
    where TEntity : class
{
    ...
    public virtual async Task<TEntity?> GetByIdAsync(Guid Id, Func<IQueryable<TEntity>, IQueryable<TEntity>>? include = null, CancellationToken cancellationToken = default)
    {
