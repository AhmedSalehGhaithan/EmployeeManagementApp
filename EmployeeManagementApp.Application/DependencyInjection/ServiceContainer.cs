using EmployeeManagementApp.Application.Common.Mapping;
using EmployeeManagementApp.Application.Service;
using FluentValidation;
using FluentValidation.AspNetCore;
using MediatR;
using Microsoft.Extensions.DependencyInjection;

namespace EmployeeManagementApp.Application.DependencyInjection;
